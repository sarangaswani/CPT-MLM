...
const Card = () => {
  ...
  return (
    <div
    className="max-w-xs rounded-xl shadow-md overflow-hidden md:max-w-md hover:shadow-xl transition duration-300 flex flex-col absolute top-24 right-10 w-full group bg-gradient-to-br from-purple-950 to-MiddlePurple dark:text-white animate-bounce-2s"
  >
