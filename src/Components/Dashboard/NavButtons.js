...
export default function NavButtons(props) {
  return (
    <div className="relative flex h-12 mt-8 items-center justify-between border-gray-300 mb-3">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div className="flex flex-shrink-0 items-center">
          <img className="h-8 w-8 mr-2" src={Logo} alt="ProsperChain Logo" />
          <h1 className="text-white font-bold text-md">ToPayCoin</h1>
        </div>
      </div>
